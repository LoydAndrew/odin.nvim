...
function theme.highlights(colors, config)
  ...
  local function load_syntax()
    ...
    local syntax = {
      ...
      Underlined = { fg = colors.green, style = "bold", cterm = "bold" },
      -- left blank, hidden
  ...
  local function load_editor()
    ...
    local editor = {
      ...
      NormalFloat = { fg = colors.fg, bg = colors.active }, -- NOTE: this is crucial for lsp
      -- floating window border
      FloatBorder = { fg = colors.blue, bg = colors.active }, -- NOTE:this is crucial for lsp
      ...
      MatchParen = { fg = colors.red, bg = colors.none, style = "bold" },
      ...
      Pmenu = { fg = colors.fg, bg = colors.float2 },
      -- selected item |hl-PmenuSel|
      PmenuSel = { bg = colors.selection2 },
      ...
      QuickFixLine = { bg = colors.float2, style = "bold,italic" },
      ...
      CursorLine = { fg = colors.none, bg = colors.cursorline },
  ...
  local function load_lsp()
    ...
    local lsp = {
      ...
      LspReferenceText = { style = colors.none, bg = colors.highlight },
      -- used for highlighting "read" references
      LspReferenceRead = { style = colors.none, bg = colors.highlight },
      -- used for highlighting "write" references
      LspReferenceWrite = { style = colors.none, bg = colors.highlight },

      LspSignatureActiveParameter = {
        fg = colors.none,
        bg = colors.highlight_dark,
        style = "bold",
      },
  ...
  local function load_plugins()
    ...
    local plugins = {
      -- Cmp
      -- CmpDocumentation = { fg = colors.float2, bg = colors.float2 },
      -- CmpDocumentationBorder = { fg = colors.float2, bg = colors.float2},
      -- CmpCompletionBorder = { fg = colors.fg, bg = colors.float2 },
      ...
      -- CmpDocumentation = { fg = colors.fg, bg = colors.float2 },
      -- CmpDocumentationBorder = { fg = colors.fg, bg = colors.float2 },
      ...
      BufferLineBackground = { fg = colors.light_gray, bg = colors.cursorline },
      -- BufferLineBufferVisible = { fg = spec.fg1, bg = spec.bg0 },
      -- BufferLineBufferSelected = { fg = colors.fg, bg = colors.bg, style = "bold" },
      ...
      BufferLineSeparator = { fg = colors.light_gray, bg = colors.cursorline },
      BufferLineSeparatorVisible = { fg = colors.cyan },
      BufferLinePick = { fg = colors.red, bg = "none", style = "none" },
      BufferLineSeparatorSelected = { fg = colors.cyan, bg = colors.cyan },
